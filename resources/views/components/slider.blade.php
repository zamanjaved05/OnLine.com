                                                ...
                                                <div class="product-form__item">
                                                    ...
                                                    <div data-value="Red" class="swatch-element color red available">
                                                        ...
                                                        <label class="swatchLbl color medium rectangle"
                                                               for="swatch-0-red"
                                                               style="background-images:url(assets/images/product-detail-page/variant1-1.jpg);"
                                                               title="Red"></label>
                                                    </div>
                                                    <div data-value="Blue" class="swatch-element color blue available">
                                                        ...
                                                        <label class="swatchLbl color medium rectangle"
                                                               for="swatch-0-blue"
                                                               style="background-images:url(assets/images/product-detail-page/variant1-2.jpg);"
                                                               title="Blue"></label>
                                                    </div>
                                                    <div data-value="Green"
                                                        ...
                                                        <label class="swatchLbl color medium rectangle"
                                                               for="swatch-0-green"
                                                               style="background-images:url(assets/images/product-detail-page/variant1-3.jpg);"
                                                               title="Green"></label>
                                                    </div>
                                                    <div data-value="Gray" class="swatch-element color gray available">
                                                        ...
                                                        <label class="swatchLbl color medium rectangle"
                                                               for="swatch-0-gray"
                                                               style="background-images:url(assets/images/product-detail-page/variant1-4.jpg);"
                                                               title="Gray"></label>
                                                    </div>
                                                </div>
                                            </div>
...
{{--                            <img src="/images/{{ $product->images }}" alt="" class="w-full max-h-60">--}}
{{--                        </a>--}}
