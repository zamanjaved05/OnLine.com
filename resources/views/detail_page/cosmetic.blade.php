                        ...
                        <div class="product-details-img">
                            <div class="product-thumb">
                                <div id="gallery" class="product-dec-slider-2 product-tab-left">
                                    <a data-image="{{asset('image/cosmetic/'.$product->image)}}" data-zoom-image="{{asset('image/cosmetic/'.$product->image)}}" class="slick-slide slick-cloned" data-slick-index="-4" aria-hidden="true" tabindex="-1">
                                        <img class="blur-up lazyload" src="{{asset('image/cosmetic/'.$product->image)}}" alt="" />
                                    </a>
                                    <a data-image="{{asset('image/cosmetic/'.$product->image)}}" data-zoom-image="{{asset('image/cosmetic/'.$product->image)}}" class="slick-slide slick-cloned" data-slick-index="-3" aria-hidden="true" tabindex="-1">
                                        <img class="blur-up lazyload" src="{{asset('image/cosmetic/'.$product->image)}}" alt="" />
                                    </a>
                                    <a data-image="{{asset('image/cosmetic/'.$product->image)}}" data-zoom-image="{{asset('image/cosmetic/'.$product->image)}}" class="slick-slide slick-cloned" data-slick-index="-2" aria-hidden="true" tabindex="-1">
                                        <img class="blur-up lazyload" src="{{asset('image/cosmetic/'.$product->image)}}" alt="" />
                                    </a>
                                    <a data-image="{{asset('image/cosmetic/'.$product->image)}}" data-zoom-image="{{asset('image/cosmetic/'.$product->image)}}" class="slick-slide slick-cloned" data-slick-index="-1" aria-hidden="true" tabindex="-1">
                                        <img class="blur-up lazyload" src="{{asset('image/cosmetic/'.$product->image)}}" alt="" />
                                    </a>
                                    <a data-image="{{asset('image/cosmetic/'.$product->image)}}" data-zoom-image="{{asset('image/cosmetic/'.$product->image)}}" class="slick-slide slick-cloned" data-slick-index="0" aria-hidden="true" tabindex="-1">
                                        <img class="blur-up lazyload" src="{{asset('image/cosmetic/'.$product->image)}}" alt="" />
                                    </a>
                                    <a data-image="{{asset('image/cosmetic/'.$product->image)}}" data-zoom-image="{{asset('image/cosmetic/'.$product->image)}}" class="slick-slide slick-cloned" data-slick-index="1" aria-hidden="true" tabindex="-1">
                                        <img class="blur-up lazyload" src="{{asset('image/cosmetic/'.$product->image)}}" alt="" />
                            ...
                            <div class="zoompro-wrap product-zoom-right pl-20">
                                <div class="zoompro-span">
                                    <img class="zoompro blur-up lazyload" data-zoom-image="{{asset('image/cosmetic/'.$product->image)}}" alt="" src="{{asset('image/cosmetic/'.$product->image)}}" />
                                </div>
                            ...
                            <div class="lightboximages">
                                <a href="{{asset('image/cosmetic/'.$product->image)}}" data-size="1462x2048"></a>
                                <a href="{{asset('image/cosmetic/'.$product->image)}}" data-size="1462x2048"></a>
                                <a href="{{asset('image/cosmetic/'.$product->image)}}" data-size="1462x2048"></a>
                                <a href="{{asset('image/cosmetic/'.$product->image)}}" data-size="1462x2048"></a>
                                <a href="{{asset('image/cosmetic/'.$product->image)}}" data-size="1462x2048"></a>
                                <a href="{{asset('image/cosmetic/'.$product->image)}}" data-size="1462x2048"></a>
                                <a href="{{asset('image/cosmetic/'.$product->image)}}" data-size="731x1024"></a>
                            </div>
                ...
                <div class="productPageSlider">
                    <div class="col-12 item">
                        ...
                        <div class="product-details text-center">
                            ...
                            <!-- Variant -->
                            <ul class="swatches">
                                <li class="swatch medium rounded"><img src="{{asset('image/cosmetic/'.$product->image)}}" alt="image" /></li>
                                <li class="swatch medium rounded"><img src="{{asset('image/cosmetic/'.$product->image)}}" alt="image" /></li>
                                <li class="swatch medium rounded"><img src="{{asset('image/cosmetic/'.$product->image)}}" alt="image" /></li>
                                <li class="swatch medium rounded"><img src="{{asset('image/cosmetic/'.$product->image)}}" alt="image" /></li>
                                <li class="swatch medium rounded"><img src="{{asset('image/cosmetic/'.$product->image)}}" alt="image" /></li>
