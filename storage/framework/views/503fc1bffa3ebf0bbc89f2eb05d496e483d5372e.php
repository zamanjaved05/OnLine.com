...
<!--End Header-->
                                    ...
                                    <div class="input-group">
                                        ...
                                        <span class="input-group__btn">
                                                <button type="submit" class="btn newsletter__submit" name="commit"
                                                        id="Subscribe"><span class="newsletter__submit-text--large">Subscribe</span></button>
                                            </span>
                                    </div>
                                </form>
                            </div>
                        ...
                        <div class="col-12 col-sm-12 col-md-3 col-lg-3 contact-box">
                            ...
                            <ul class="addressFooter">
                                <li><i class="icon anm anm-map-marker-al"></i>
                                    <p>55 Gallaxy Enque,<br>2568 steet, 23568 NY</p></li>
    ...
    <!--Quick View popup-->
    <div class="modal fade quick-view-popup " id="content_quickview" style="height: 90%">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                                        <div class="product-single__meta">
                                            ...
                                            <span id="ProductPrice-product-template"><span
                                                    class="money"><input type="text" id="price" style="border: none" readonly></span></span>
                                        </span>
                                            </p>
                                            <div class="product-single__description rte">
                                                <input type="text" id="description" style="border: none" readonly>
                                            </div>
                                                    ...
                                                    <div class="product-form__item">
                                                        ...
                                                        <div data-value="Red" class="swatch-element color red available">
                                                            ...
                                                            <label class="swatchLbl color medium rectangle"
                                                                   for="swatch-0-red"
                                                                   style="background-image:url('<?php echo e('/image/products/'.$product->image); ?>');"
                                                                   title="Red"></label>
                                                        </div>
        ...
        function modaldetail(dgdfgdfh) {
            ...
            $.ajax({
                ...
                success: function (res) {
                    ...
                    $("#image").html(
                        `<img src="image/products/${res.image}" style="width:100%" alt="" title=""/>`);
