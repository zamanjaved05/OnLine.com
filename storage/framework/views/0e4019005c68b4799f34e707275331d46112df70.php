        ...
        <div class="row">
            <div class="col-12 col-sm-12 col-md-8 col-lg-8 mb-4">
                ...
                <div class="formFeilds contact-form form-vertical">
                    <form action="<?php echo e(url('mail')); ?>" method="post"  id="contact_form" class="contact-form">
                        <?php echo csrf_field(); ?>
                        <div class="row">
...
<?php echo $__env->make('layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp8.1.2\htdocs\OnLine.com\resources\views/content/contact_us.blade.php ENDPATH**/ ?>