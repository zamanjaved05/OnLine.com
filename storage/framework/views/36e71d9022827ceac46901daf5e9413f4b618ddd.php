                                    ...
                                    <div class="col-12 item">
                                        ...
                                        <div class="product-image">
                                            ...
                                            <a href="<?php echo e(url("shoes_detail/$shoe->id")); ?>">
                                                <!-- image -->
                                                <img class="primary blur-up lazyload"
                                                     data-src="storage/images/<?php echo e($shoe->image); ?>"
                                                     src="storage/images/<?php echo e($shoe->image); ?>" alt="image"
                                                     title="product">
                                                <!-- End image -->
                                                <!-- Hover image -->
                                                <img class="hover blur-up lazyload"
...
<?php echo $__env->make('layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp8.1.2\htdocs\OnLine.com\resources\views/content/products.blade.php ENDPATH**/ ?>